...
import styles from "./EndTrack.module.css";
    ...
    <Box className={styles.outerbox}>
      <Flex gap="6rem" className={styles.outerflex}>
        <Box className={styles.innerbox}>
          <Text className={styles.EndTrack_heading1}>
            Start tracking time today
          </Text>
          <Text className={styles.EndTrack_heading2} marginTop="1rem">
